            ...
            <Card className="p-8">
              ...
              <form className="space-y-6">
                <div className="relative">
                  <Input type="text" placeholder="Name" className="pr-10" />
                ...
                <div className="relative">
                  <Input type="tel" placeholder="Number" className="pr-10" />
                  <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                ...
                <div className="relative">
                  <Textarea placeholder="Details" rows={4} className="pr-10" />
